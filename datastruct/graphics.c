...
#ifdef GDKTEST
int data_row_length = 9;
int data_column_length = 9;

// Sample Level 0 Maze 
static int data2[9][9] = {
{ 10, 14, 10, 16, 10, 16, 10, 16, 10 } ,
{ 16, 15, 16, 15, 16, 15, 13, 15, 16 } ,
{ 10, 16, 10, 14, 10, 14, 10, 14, 10 } ,
{ 13, 15, 13, 15, 16, 15, 16, 15, 13 } ,
{ 10, 16, 10, 16, 10, 14, 10, 16, 10 } ,
{ 16, 15, 13, 15, 13, 15, 13, 15, 16 } ,
{ 10, 16, 10, 14, 10, 16, 10, 16, 10 } ,
{ 16, 15, 16, 15, 16, 15, 13, 15, 13 } ,
{ 10, 14, 10, 16, 10, 16, 10, 16, 10 } ,
};
#else
...
int **data2;
int data_row_length;
int data_column_length;

void set_maze(int  **walls, int width, int height)
{
    data2 = walls;
    data_row_length = 2*width-1;
    data_column_length = 2*height-1;
}
...
void render_maze(){
    ...
    gint timer = g_timeout_add(UPDATE_INTERVAL, timer_tic, NULL);
